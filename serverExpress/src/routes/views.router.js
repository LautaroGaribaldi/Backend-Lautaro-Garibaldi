...
class ViewsRouter extends RouterClass {
    init() {
        ...
        this.get("/carts/:cid", ["ADMIN"], async (req, res) => {
            try {
        ...
        this.get("/login", ["PUBLIC"], loged, async (req, res) => {
            const object = {
                style: "index.css",
                title: "Login",
                //products: payload,
        ...
        this.get("/recoveryPassword", ["PUBLIC"], loged, async (req, res) => {
            const object = {
                style: "index.css",
        ...
        this.get("/register", ["PUBLIC"], loged, async (req, res) => {
            const object = {
                style: "index.css",
                title: "register",
            };
        ...
        this.get("/profile", ["PUBLIC"], notLoged, async (req, res) => {
            let loged = false;
            if (req.cookies.coderCookieToken) {
                loged = true;
            }
